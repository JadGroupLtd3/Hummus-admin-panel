...
class DealsNavBar extends StatelessWidget {
  final SliderPagesController sliderPagesController;

  const DealsNavBar({super.key, required this.sliderPagesController});
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              color: sliderPagesController.currentDealName.value == 0
                  ? MyThemeData.light.primaryColor
                  : sliderPagesController.currentDealName.value == 1
                  ? MyThemeData.light.primaryColor
                  : Colors.white,
            ),
            ...
            Container(
              height: 1,
              width: MediaQuery.of(context).size.height * 1 / 5.5,
              color: sliderPagesController.currentDealName.value == 1 ||
                  sliderPagesController.currentDealName.value == 2
                  ? MyThemeData.light.primaryColor
                  : Colors.white,
            ),
        ...
        Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TajawalRegular.copyWith(
                fontSize: 14,
                color: sliderPagesController.currentDealName.value == 2
                    ? MyThemeData.light.primaryColor
                    : Colors.black,
              ),
            ).paddingOnly(top: 10),
  ...
  Widget questionNavBarItem(int page) {
    return OnHover(
      matrix: 0,
      onTap: () {
        sliderPagesController.goToDealsNameTab(page);
      },
      builder: (isHovered) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: sliderPagesController.currentDealName.value == page
                ? MyThemeData.light.primaryColor
                : color,
          ),
          child: sliderPagesController.currentDealName.value == page
