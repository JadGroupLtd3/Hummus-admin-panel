            ...
            Obx(
              () {
                if (hashtagController.controllerState.value ==
                  ...
                  final int totalPages = (hashtagController.hashtagList.length / itemsPerPage).ceil();
                  final currentPageItems = hashtagController.hashtagList.skip(currentPage * itemsPerPage).take(itemsPerPage).toList();
                  return Expanded(
                    child: Column(
                      children: [
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final hashtag = currentPageItems[index];
                              return Table(
                                columnWidths: const {
                                  1: IntrinsicColumnWidth(),
                                },
