...
class QuestionsNavBar extends StatelessWidget {
  final SliderPagesController sliderPagesController;

  const QuestionsNavBar({super.key, required this.sliderPagesController});
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              color: sliderPagesController.currentQuestionName.value == 0
                  ? MyThemeData.light.primaryColor
                  : sliderPagesController.currentQuestionName.value == 1
                      ? MyThemeData.light.primaryColor
                      : Colors.white,
            ),
            ...
            Container(
              height: 2,
              width: MediaQuery.of(context).size.height * 1 / 5.5,
              color: sliderPagesController.currentQuestionName.value == 1 ||
                      sliderPagesController.currentQuestionName.value == 2
                  ? MyThemeData.light.primaryColor
                  : Colors.white,
            ),
        ...
        Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TajawalRegular.copyWith(
                fontSize: 14,
                color: sliderPagesController.currentQuestionName.value == 2
                    ? MyThemeData.light.primaryColor
                    : Colors.black,
              ),
            ).paddingOnly(top: 10),
  ...
  Widget questionNavBarItem(int page) {
    return OnHover(
      matrix: 0,
      onTap: () {
        sliderPagesController.goToQuestionsNameTab(page);
      },
      builder: (isHovered) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: sliderPagesController.currentQuestionName.value == page
                ? MyThemeData.light.primaryColor
                : color,
          ),
          child: sliderPagesController.currentQuestionName.value == page
