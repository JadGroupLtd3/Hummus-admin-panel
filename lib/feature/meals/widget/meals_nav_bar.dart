...
class MealsNavBar extends StatelessWidget {
  final SliderPagesController sliderPagesController;

  const MealsNavBar({super.key, required this.sliderPagesController});
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              color: sliderPagesController.currentMealName.value == 0
        ...
        Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TajawalRegular.copyWith(
                fontSize: 14,
                color: sliderPagesController.currentMealName.value == 2
                    ? MyThemeData.light.primaryColor
                    : Colors.black,
              ),
            ).paddingOnly(top: 10),
      ...
      builder: (isHovered) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: sliderPagesController.currentMealName.value == page
                ? MyThemeData.light.primaryColor
                : color,
          ),
          child: sliderPagesController.currentMealName.value == page
