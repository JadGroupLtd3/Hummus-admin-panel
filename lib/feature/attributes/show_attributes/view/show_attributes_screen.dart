...
class ShowAttributesScreen extends StatelessWidget {
  const ShowAttributesScreen({super.key});
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                '${'Home'.tr} / ${'Attributes'.tr} / ${'Show attributes'.tr}',
                  ...
                  OnHover(
                    builder: (isHovered) {
                      return CustomButton(
                        ...
                        height: 45,
                        onPressed: (){
                          Get.find<SliderPagesController>().goToTab(23);
                        },
                      );
                    },
                  ),
