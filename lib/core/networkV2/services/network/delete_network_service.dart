...
class DeleteNetworkService<T> extends NetworkService<T> {
  DeleteNetworkService(super.client, super.logger, super.errorKey,
  ...
  FutureEitherType<T> request(String url,
    ...
    try {
      final response = await client
          .delete(Uri.parse(url), headers: mergeHeaders(headers))
